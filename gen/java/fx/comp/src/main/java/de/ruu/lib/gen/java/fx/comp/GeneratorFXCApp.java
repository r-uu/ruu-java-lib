...
public class GeneratorFXCApp
{
	private String packageName;
	private String simpleFileName;

	public GeneratorFXCApp(String packageName, String simpleFileName)
	{
	...
	public void run() throws GeneratorException, IOException
	{
		...
		GeneratorClass generator =
				...
				(
						javaDoc(context)
								.add("Java FX Component Application {@link " + simpleFileName + "}")
								.add("<p>")
