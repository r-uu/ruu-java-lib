...
public class TextFieldAutoCompleteClearableWithArrowButtonCountryDemo extends Application
{
	@Override	public void start(Stage stage)
	{
		TextFieldAutoCompleteClearableWithArrowButton<Country> textField =
				(TextFieldAutoCompleteClearableWithArrowButton<Country>) TextFieldAutoCompleteClearableWithArrowButtonBuilder.<Country>create()
